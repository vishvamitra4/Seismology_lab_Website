...
function NewsletterSlider() {
    ...
    const handleNextClick = () => {
        setCurrentPostIndex((prevIndex) =>
            prevIndex === newsletterPosts.length - 1 ? 0 : prevIndex + 1
        );
    };

    const handlePrevClick = () => {
        setCurrentPostIndex((prevIndex) =>
            prevIndex === 0 ? newsletterPosts.length - 1 : prevIndex - 1
        );
    };

    const currentPost = newsletterPosts[currentPostIndex];

    return (
        <div className="newsletter-slider">
            <div className="slider-content">
                <img src={currentPost.imageUrl} alt={currentPost.heading} />
